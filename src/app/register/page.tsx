      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="card shadow-lg card-body  w-[80%] h-[100%] mx-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="">
            ...
            <div className="form-control mb-3">
              <label className="label">
                <span className="label-text text-gray-600 ml-2">Email</span>
              </label>
              <input
                type="email"
          ...
          {/* Google Sign Up */}
          <div className="border-2 border-[#FACE39] rounded-xl py-3 my-6 mx-auto w-full flex justify-center mb-10 mt-2">
